...
/datum/action/cooldown/spell/divulge/cast(atom/cast_on)
	...
	for(var/stage in 1 to 3)
		...
		switch(stage)
			if(1)
				...
				playsound(user, 'sound/magic/darkspawn/divulge_01.ogg', 30, 0)
			if(2)
				...
				playsound(user, 'sound/magic/darkspawn/divulge_02.ogg', 40, 0)
			if(3)
				...
				playsound(user, 'sound/magic/darkspawn/divulge_03.ogg', 50, 0)
	...
	playsound(user, 'sound/magic/darkspawn/divulge_end.ogg', 50, 0)
