/datum/gas_reaction/water_vapor/init_factors()
	factor = list(
		GAS_H2O = "Condensation will consume [MOLES_GAS_VISIBLE] moles, freezing will not consume any. Both needs a minimum of [MOLES_GAS_VISIBLE] moles to occur.",
...
/datum/gas_reaction/plasmafire/init_factors()
	factor = list(
		...
		GAS_H2O = "Water vapor is formed at 0.25 moles per mole of plasma consumed if tritium isn't being formed.",
		GAS_CO2 = "Carbon Dioxide is formed at 0.75 moles per mole of plasma consumed if tritium isn't being formed.",
...
/datum/gas_reaction/tritfire/init_factors()
	factor = list(
		GAS_O2 = "Oxygen is consumed at 0.5 moles per mole of tritium consumed. Higher oxygen concentration up to [TRITIUM_OXYGEN_FULLBURN] times the tritium increases the tritium consumption rate.",
		/datum/gas/tritium = "Tritium is consumed at rapidly fast as long as there's enough oxygen to allow combustion.",
		GAS_H2O = "Water vapor is produced at 1 mole per mole of tritium combusted.",
		"Temperature" = "Minimum temperature of [FIRE_MINIMUM_TEMPERATURE_TO_EXIST] kelvin to occur",
...
/datum/gas_reaction/nitrousformation/init_factors()
	factor = list(
		GAS_O2 = "10 moles of Oxygen needs to be present for the reaction to occur. Oxygen is consumed at 0.5 moles per mole of nitrous oxide formed.",
		GAS_N2 = " 20 moles of Nitrogen needs to be present for the reaction to occur. Nitrogen is consumed at 1 mole per mole of nitrous oxide formed.",
		GAS_BZ = "5 moles of BZ needs to be present for the reaction to occur. Not consumed.",
		GAS_NITROUS = "Nitrous oxide gets produced rapidly.",
...
/datum/gas_reaction/nitrous_decomp/init_factors()
	factor = list(
		GAS_NITROUS = "Nitrous Oxide is decomposed at a rate that scales negatively with the distance between the temperature and average of the minimum and maximum temperature of the reaction. Minimum of [MINIMUM_MOLE_COUNT * 2] to occur.", //okay this one isn't made into a define yet.
		GAS_O2 = "Oxygen is formed at 0.5 moles per mole of nitrous oxide decomposed.",
		GAS_N2 = "Nitrogen is formed at 1 mole per mole of nitrous oxide decomposed.",
...
/datum/gas_reaction/bzformation/init_factors()
	factor = list(
		...
		GAS_NITROUS = "Each mole of bz made consumes 0.4 moles of Nitrous oxide. If there is less nitrous oxide than plasma the reaction rate is slowed down. At three times the amount of plasma to Nitrous oxide it will start breaking down into Nitrogen and Oxygen, the lower the ratio the more Nitrous oxide decomposes.",
		GAS_BZ = "The lower the pressure and larger the volume the more bz gets made. Less nitrous oxide than plasma will slow down the reaction.",
		GAS_N2 = "Each mole Nitrous oxide decomposed makes 1 mol Nitrogen. Lower ratio of Nitrous oxide to Plasma means a higher ratio of decomposition to BZ production.",
		GAS_O2 = "Each mole Nitrous oxide decomposed makes 0.5 moles Oxygen. Lower ratio of Nitrous oxide to Plasma means a higher ratio of decomposition to BZ production.",
...
/datum/gas_reaction/nitrium_formation/init_factors()
	factor = list(
		GAS_BZ = "5 moles of BZ needs to be present for the reaction to occur. BZ is consumed at 0.05 moles per mole of nitrium formed.",
		...
		GAS_N2 = "10 moles of nitrogen needs to be present for the reaction to occur. Nitrogen is consumed at 1 mole per mole of nitrium formed.",
		GAS_NITRIUM = "Nitrium is produced at a rate that scales with the temperature.",
...
/datum/gas_reaction/nobliumformation/init_factors()
	factor = list(
		GAS_N2 = "10 moles of nitrogen needs to be present for the reaction to occur. Nitrogen is consumed at 10 moles per mole of hypernoblium formed.",
		...
		GAS_HYPERNOB = "Hyper-Noblium production scales based on the sum of the nitrogen and tritium moles.",
		"Energy" = "[NOBLIUM_FORMATION_ENERGY] joules of energy is released per mole of hypernoblium produced.",
		GAS_BZ = "BZ is not consumed in the reaction but will lower the amount of energy released. It also reduces amount of tritium consumed by a ratio between tritium and bz, greater bz than tritium will reduce more.",
...
/datum/gas_reaction/proto_nitrate_bz_response/init_factors()
	factor = list(
		...
		GAS_BZ = "BZ gets decomposed into plasma and nitrous oxide. The nitrous oxide then decomposes into nitrogen and oxygen, with the oxygen then decaying into helium.",
		GAS_N2 = "Nitrogen is produced at 0.4 moles per mole of BZ decomposed.",
