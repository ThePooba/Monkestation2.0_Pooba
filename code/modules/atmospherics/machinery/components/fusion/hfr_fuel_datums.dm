...
/datum/hfr_fuel/plasma_oxy_fuel
	...
	requirements = list(/datum/gas/plasma, GAS_O2)
...
/datum/hfr_fuel/hydrogen_oxy_fuel
	...
	secondary_products = list(/datum/gas/helium, /datum/gas/plasma, GAS_O2, GAS_N2, GAS_BZ, GAS_HYPERNOB)
...
/datum/hfr_fuel/tritium_oxy_fuel
	...
	requirements = list(/datum/gas/tritium, GAS_O2)
...
/datum/hfr_fuel/hydrogen_tritium_fuel
	...
	requirements = list(GAS_H2, /datum/gas/tritium)
...
/datum/hfr_fuel/hypernob_hydrogen_fuel
	...
	secondary_products = list(GAS_ANTINOB, /datum/gas/helium, /datum/gas/proto_nitrate, GAS_ZAUKER, GAS_HEALIUM, GAS_MIASMA)
...
/datum/hfr_fuel/hypernob_trit_fuel
	...
	requirements = list(GAS_HYPERNOB, /datum/gas/tritium)
	primary_products = list(GAS_ANTINOB)
	secondary_products = list(GAS_ANTINOB, /datum/gas/helium, /datum/gas/proto_nitrate, GAS_ZAUKER, GAS_HEALIUM, GAS_MIASMA)
	meltdown_flags = HYPERTORUS_FLAG_DEVASTATING_EXPLOSION | HYPERTORUS_FLAG_RADIATION_PULSE | HYPERTORUS_FLAG_EMP | HYPERTORUS_FLAG_BIG_SPREAD
...
/datum/hfr_fuel/hypernob_antinob_fuel
	...
	primary_products = list(/datum/gas/helium)
	secondary_products = list(/datum/gas/plasma, GAS_O2, GAS_N2, /datum/gas/proto_nitrate, GAS_NITRIUM, GAS_MIASMA)
