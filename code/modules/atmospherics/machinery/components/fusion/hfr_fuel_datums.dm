...
/datum/hfr_fuel/plasma_oxy_fuel
	...
	secondary_products = list(GAS_CO2, GAS_H2O, /datum/gas/freon, GAS_NITROUS, /datum/gas/pluoxium, /datum/gas/halon)
...
/datum/hfr_fuel/hypernob_antinob_fuel
	...
	primary_products = list(/datum/gas/helium)
	secondary_products = list(/datum/gas/plasma, GAS_O2, GAS_N2, /datum/gas/proto_nitrate, GAS_NITRIUM, /datum/gas/miasma)
