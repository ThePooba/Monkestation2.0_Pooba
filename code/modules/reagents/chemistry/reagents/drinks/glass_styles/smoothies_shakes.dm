...
/datum/glass_style/drinking_glass/vanillashake
	...
	name = "vanilla shake"
	desc = "A vanilla milkshake with a dollop of icing shaped like a bunny on top."
	icon = 'icons/obj/drinks/shakes.dmi'
...
/datum/glass_style/drinking_glass/caramelshake
	...
	name = "caramel shake"
	desc = "A rich caramel milkshake with a cherry, whipped cream, and caramel drizzle."
	icon = 'icons/obj/drinks/shakes.dmi'
...
/datum/glass_style/drinking_glass/choccyshake
	...
	desc = "A frosty chocolate milkshake with a cherry, whipped cream, and chocolate drizzle."
	icon = 'icons/obj/drinks/shakes.dmi'
...
/datum/glass_style/drinking_glass/funky_monkey
	...
	desc = "A banana shake with chocolate sparkles and drizzle over whipped cream. A baby monkey cookie hangs off the side. No monkeys were harmed, officially."
	icon = 'icons/obj/drinks/shakes.dmi'
...
/datum/glass_style/drinking_glass/melon_baller
	...
	desc = "A slightly alcoholic watermelon smoothie served in the shell of a watermelon, there is a straw with a little plastic sun that reminds you of summer."
	icon = 'icons/obj/drinks/shakes.dmi'
...
/datum/glass_style/drinking_glass/vanilla_dream
	...
	desc = "A sweet vanilla smoothie that sparkles and looks as fragile as a dream."
	icon = 'icons/obj/drinks/shakes.dmi'
