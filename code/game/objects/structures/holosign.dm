...
/obj/structure/holosign/wetsign
	name = "wet floor sign"
	icon = 'icons/effects/effects.dmi' //spinny sign cooler
...
/obj/structure/holosign/barrier/atmos/BlockThermalConductivity() //Didn't used to do this, but it's "normal", and will help ease heat flow transitions with the players.
	return TRUE
