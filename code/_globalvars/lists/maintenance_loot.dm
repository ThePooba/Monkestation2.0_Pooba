...
//monkestation edit start
	list(//artifacts
		...
		/obj/item/a_gift/anything/wiz_name = 1,
		) = 8,
...
#define maint_holiday_weight 1000 // When holiday loot is enabled, it'll give every loot item a 25% chance of being a holiday item
