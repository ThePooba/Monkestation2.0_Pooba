...
GLOBAL_LIST_INIT(traits_by_type, list(
	...
	/atom/movable = list(
		...
		"TRAIT_GOES_THROUGH_WOODEN_BARRICADES" = TRAIT_GOES_THROUGH_WOODEN_BARRICADES,
		...
		/* "TRAIT_SHADOWLESS" = TRAIT_SHADOWLESS, */
	...
	/datum/controller/subsystem/processing/station = list(
		...
		"STATION_TRAIT_CLOWN_BRIDGE" = STATION_TRAIT_CLOWN_BRIDGE,
...
*/
	...
	/obj = list(
		"TRAIT_HIDDEN_EXPORT_VALUE" = TRAIT_HIDDEN_EXPORT_VALUE,
		"TRAIT_MOB_DESTROYABLE" = TRAIT_MOB_DESTROYABLE,
	...
	/mob = list(
		...
		"TRAIT_AKIMBO" = TRAIT_AKIMBO,
		"TRAIT_NO_RECOIL" = TRAIT_NO_RECOIL,
		...
		"TRAIT_ALL_SURGERIES" = TRAIT_ALL_SURGERIES,
		...
		"TRAIT_BORG_PUNCHER" = TRAIT_BORG_PUNCHER,
		...
		"TRAIT_CAFFEINE_DEPENDENCE" = TRAIT_CAFFEINE_DEPENDENCE,
		...
		"TRAIT_CAN_USE_FLIGHT_POTION" = TRAIT_CAN_USE_FLIGHT_POTION,
		...
		"TRAIT_CORRUPTED_MONITOR" = TRAIT_CORRUPTED_MONITOR, // monkestation edit PR #5133
		...
		"TRAIT_DARKSPAWN_BUFFALLIES" = TRAIT_DARKSPAWN_BUFFALLIES,
		"TRAIT_DARKSPAWN_CREEP" = TRAIT_DARKSPAWN_CREEP,
		"TRAIT_DARKSPAWN_DEVOURED" = TRAIT_DARKSPAWN_DEVOURED,
		"TRAIT_DARKSPAWN_LIGHTRES" = TRAIT_DARKSPAWN_LIGHTRES,
		"TRAIT_DARKSPAWN_PSIBLOCK" = TRAIT_DARKSPAWN_PSIBLOCK,
		"TRAIT_DARKSPAWN_UNDYING" = TRAIT_DARKSPAWN_UNDYING,
		...
		"TRAIT_DISORIENTED" = TRAIT_DISORIENTED,
		...
		"TRAIT_ETHEREAL_NO_OVERCHARGE" = TRAIT_ETHEREAL_NO_OVERCHARGE,
		"TRAIT_ENTRAILS_READER" = TRAIT_ENTRAILS_READER,
		"TRAIT_EVIL" = TRAIT_EVIL,
		"TRAIT_EXHAUSTED" = TRAIT_EXHAUSTED,
		"TRAIT_EXPANDED_FOV" = TRAIT_EXPANDED_FOV,
		"TRAIT_EXTROVERT" = TRAIT_EXTROVERT,
		"TRAIT_FAKEDEATH" = TRAIT_FAKEDEATH,
		"TRAIT_FASTER_SLAB_INVOKE" = TRAIT_FASTER_SLAB_INVOKE,
		"TRAIT_FASTMED" = TRAIT_FASTMED,
		"TRAIT_FAST_CLIMBER" = TRAIT_FAST_CLIMBER,
		"TRAIT_FAST_COOLDOWNS" = TRAIT_FAST_COOLDOWNS,
		"TRAIT_FAT" = TRAIT_FAT,
		...
		"TRAIT_FOOD_FIRE_BURPS" = TRAIT_FOOD_FIRE_BURPS,
		"TRAIT_FOOD_JOB_BOTANIST" = TRAIT_FOOD_JOB_BOTANIST,
		"TRAIT_FOOD_JOB_MINER" = TRAIT_FOOD_JOB_MINER,
		"TRAIT_FOOD_SLIDE" = TRAIT_FOOD_SLIDE,
		...
		"TRAIT_LIGHT_SLEEPER" = TRAIT_LIGHT_SLEEPER,
		"TRAIT_THROW_GUNS" = TRAIT_THROW_GUNS,
		...
		"TRAIT_IMPACTIMMUNE" = TRAIT_IMPACTIMMUNE,
		...
		"TRAIT_JOINED_AS_CREW" = TRAIT_JOINED_AS_CREW,
		...
		"TRAIT_MINING_CALLOUTS" = TRAIT_MINING_CALLOUTS,
		"TRAIT_MOB_BREEDER" = TRAIT_MOB_BREEDER,
		"TRAIT_MONKEYFRIEND" = TRAIT_MONKEYFRIEND,
		...
		"TRAIT_NO_BLOODLOSS_DAMAGE" = TRAIT_NO_BLOODLOSS_DAMAGE,
		"TRAIT_NO_BLEED_WARN" = TRAIT_NO_BLEED_WARN,
		...
		"TRAIT_PANACHEFUL_SNAPS" = TRAIT_PANACHEFUL_SNAPS,
		...
		"TRAIT_PERFECT_SURGEON" = TRAIT_PERFECT_SURGEON,
		...
		"TRAIT_PRO_SKATER" = TRAIT_PRO_SKATER,
		...
		"TRAIT_REVENANT_BLIGHT_PROTECTION" = TRAIT_REVENANT_BLIGHT_PROTECTION,
		...
		"TRAIT_SHOVE_RESIST" = TRAIT_SHOVE_RESIST,
		...
		"TRAIT_UNBORGABLE" = TRAIT_UNBORGABLE,
		...
		"TRAIT_EMBED_RESISTANCE" = TRAIT_EMBED_RESISTANCE,
		"TRAIT_NO_FINGERPRINTS" = TRAIT_NO_FINGERPRINTS,
		"TRAIT_STABILIZED_EATER" = TRAIT_STABILIZED_EATER,
	...
	/obj/item = list(
		...
		"TRAIT_ALWAYS_RENDER" = TRAIT_ALWAYS_RENDER,
	...
	/obj/item/organ/internal/spleen = list(
		"TRAIT_SPLEENLESS_METABOLISM" = TRAIT_SPLEENLESS_METABOLISM, //monkestation addition
	),
	...
	/turf/open = list(
		"TRAIT_BLOCK_LIQUID_SPREAD" = TRAIT_BLOCK_LIQUID_SPREAD,
		"TRAIT_COVERED_BY_METEOR_SHIELD" = TRAIT_COVERED_BY_METEOR_SHIELD,
		"TRAIT_TURF_HAS_ELEVATED_STRUCTURE" = TRAIT_TURF_HAS_ELEVATED_STRUCTURE,
	),
	/datum/mind = list(
		"TRAIT_CANT_SIGN_SPELLS" = TRAIT_CANT_SIGN_SPELLS,
		"TRAIT_JOINED_AS_CREW" = TRAIT_JOINED_AS_CREW,
		"TRAIT_OCCULTIST" = TRAIT_OCCULTIST,
		"TRAIT_REMOVED_FROM_MANIFEST" = TRAIT_REMOVED_FROM_MANIFEST,
		"TRAIT_UNBORGABLE" = TRAIT_UNBORGABLE,
		"TRAIT_UNCONVERTABLE" = TRAIT_UNCONVERTABLE,
	)
))
